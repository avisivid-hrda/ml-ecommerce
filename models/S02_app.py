...
# Load the model (same as your base code)
...
# Prediction
prediction, probability, input_df = predict(user_input)
...
for feature in top_features:
    ...
    if feature in input_df.columns:
        ...
        user_value = input_df[feature].values[0]

        fig, ax = plt.subplots()

        ax.barh(["User Value"], [user_value])

        ax.set_title(f"{feature} contribution in this profile")
